...
for i = 1:m
  ...
  yi = (1:num_labels == y(i)); % 10x1
  negJi = (yi * log(a3)) + ((1 - yi) * log(1 - a3));
  J -= negJi;
  
  % Back prop to determine (unregularized) gradients
  d3 = a3 - yi'; % 10x1
